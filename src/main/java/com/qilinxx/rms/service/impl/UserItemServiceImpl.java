...
public class UserItemServiceImpl implements UserItemService {
    ...
    @Override
    public List<UserItem> findUserItemByUidListItemType(List<String> uidList, String itemType) {
        return userItemMapper.findUserItemByUidListItemType(uidList, itemType);
    }
}