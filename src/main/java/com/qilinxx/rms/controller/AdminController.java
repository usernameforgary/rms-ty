...
//        response.setContentType("application/OCTET-STREAM;charset=UTF-8");
    ...
    public JSONObject ajaxProjectFile(String key,MultipartFile file, HttpSession session) throws IOException {
        ...
        if (i == 0) {
            ...
            String path = UploadUtil.getUploadFilePath() + File.separator + "upload"+File.separator+"admin"+File.separator+"temp"+File.separator+"project";//存储的根路径 临时文件目录
            File dirFile = new File(path);
            dirFile.mkdirs();
            String fileName = file.getOriginalFilename();//原文件名
            File targetFile = new File(path, fileName);
    ...
    public JSONObject ajaxThesisFile(String key,MultipartFile file, HttpSession session) throws IOException {
        ...
        if (i == 0) {
            ...
            String path = UploadUtil.getUploadFilePath() + File.separator+ "upload"+File.separator+"admin"+File.separator+"temp"+File.separator+"thesis";//存储的根路径 临时文件目录
            File dirFile = new File(path);
            dirFile.mkdirs();
            String fileName = file.getOriginalFilename();//原文件名
            File targetFile = new File(path, fileName);
    ...
    public JSONObject ajaxRewardFile(String key,MultipartFile file, HttpSession session) throws IOException {
        ...
        if (i == 0) {
            ...
            String path = UploadUtil.getUploadFilePath() + File.separator+"upload"+File.separator+"admin"+File.separator+"temp"+File.separator+"reward";//存储的根路径 临时文件目录
            File dirFile = new File(path);
            dirFile.mkdirs();
            String fileName = file.getOriginalFilename();//原文件名
            File targetFile = new File(path, fileName);
    ...
    public JSONObject ajaxTextbookFile(String key, MultipartFile file, HttpSession session) throws IOException {
        ...
        if (i == 0) {
            ...
            String path = UploadUtil.getUploadFilePath() + File.separator+"upload"+File.separator+"admin"+File.separator+"temp"+File.separator+"textbook";//存储的根路径 临时文件目录
            File dirFile = new File(path);
            dirFile.mkdirs();
            String fileName = file.getOriginalFilename();//原文件名
            File targetFile = new File(path, fileName);
